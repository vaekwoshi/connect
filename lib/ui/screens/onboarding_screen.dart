            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('어떤 소득이\n있으신가요?',
                      style: AppTheme.serif(32, ink, spacing: -0.5, height: 1.2)),
                  const SizedBox(height: 12),
                  Text('해당하는 항목을 모두 골라주세요. 아래 표제란이 유형을 판정해드려요.',
                      style: AppTheme.sans(13.5, sub, height: 1.5)),
                ],
              ),
            ),
        ...
        child: Row(
          children: [
            ...
            Text(src.cat == _Cat.labor ? '근로' : '사업',
                style: AppTheme.sans(11.5, on ? sub : tert,
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Text('유형 확정하기',
                style: AppTheme.sans(15.5, enabled ? bg : AppTheme.inkTertiary(context),
